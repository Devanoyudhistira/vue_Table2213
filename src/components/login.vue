...
<template>
    <main class="w-screen h-screen bg-linear-to-bl from-zinc-200 to-zinc-100 flex justify-center items-center ">
        <form @submit.prevent="login"
            ...
            <label class="absolute right-10 lg:top-86 top-48" for="seepassword">
